...
export default class ModelPlayer extends ModelBase {
  ...
  constructor() {
    ...
    this.head = new ModelRenderer('head', width, height).setTextureOffset(0, 0).addBox(-4.0, -8.0, -4.0, 8, 8, 8)

    // Create body ModelRenderer
    this.body = new ModelRenderer('body', width, height).setTextureOffset(16, 16).addBox(-4.0, 0.0, -2.0, 8, 12, 4)
