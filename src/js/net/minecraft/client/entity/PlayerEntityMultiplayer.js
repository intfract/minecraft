...
export default class PlayerEntityMultiplayer extends PlayerEntity {
  ...
  onUpdateWalkingPlayer() {
    ...
    let reportPosition =
      movementX * movementX + movementY * movementY + movementZ * movementZ > 9.0e-4 || this.positionUpdateTicks >= 20
    ...
    if (reportPosition && reportRotation) {
      this.networkHandler.sendPacket(
        new ClientPlayerPositionRotationPacket(this.onGround, this.x, this.y, this.z, this.rotationYaw, this.rotationPitch),
      )
