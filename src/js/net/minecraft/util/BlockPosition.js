...
export default class BlockPosition extends Vector3 {
  ...
  static fromLong(serialized) {
    let x = serialized
      .shiftLeft(64 - BlockPosition.X_SHIFT - BlockPosition.NUM_X_BITS)
      .shiftRight(64 - BlockPosition.NUM_X_BITS)
      .toNumber()
    let y = serialized
      .shiftLeft(64 - BlockPosition.Y_SHIFT - BlockPosition.NUM_Y_BITS)
      .shiftRight(64 - BlockPosition.NUM_Y_BITS)
      .toNumber()
    let z = serialized
      .shiftLeft(64 - BlockPosition.NUM_Z_BITS)
  ...
  toLong() {
    return Long.fromNumber(this.getX())
      .and(BlockPosition.X_MASK)
      .shiftLeft(BlockPosition.X_SHIFT)
